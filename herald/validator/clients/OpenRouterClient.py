...
from herald.validator.utils.config import OPENROUTER_API_KEY
from herald.validator.clients.base_client import BaseLLMClient
    ...
    def _make_request(self, model: str, **kwargs) -> Dict[str, Any]:
        ...
        try:
            headers = {
                ...
                "HTTP-Referer": "https://herald.ai",
                "X-Title": "Herald Validator"
            }
