...
Usage:
    from herald.validator.clients.llm_client import (
...
from herald.validator.clients.base_client import (
    BaseLLMClient,
    crop_transcript,
    get_prompt_version,
    parse_llm_response,
...
from herald.validator.clients.prompts import generate_brief_evaluation_prompt
...
def _load_providers():
    ...
    if not _PROVIDERS:
        from herald.validator.clients.ChuteClient import ChuteClient
        from herald.validator.clients.OpenRouterClient import OpenRouterClient
