...
from herald.validator.utils.error_handling import (
...
def handle_youtube_api_error(
    ...
    if video_id:
        params["herald_video_id"] = video_id
...
def handle_transcript_api_error(
    ...
    params = {"herald_video_id": video_id, "service": service}
...
def handle_video_data_validation_error(
    ...
    log_and_raise_processing_error(
        ...
        context={"herald_video_id": video_id, "validation_type": validation_type}
    )
...
def handle_channel_data_error(
    ...
    if channel_id:
        params["herald_channel_id"] = channel_id
