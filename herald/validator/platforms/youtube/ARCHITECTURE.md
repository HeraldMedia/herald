...
```python
from herald.validator.platforms.youtube.main import eval_youtube
...
- `calculate_video_score(video_id, client, publish_date, analytics, is_ypp_account, channel_analytics, herald_video_id) -> dict` - Complete curve-based scoring
