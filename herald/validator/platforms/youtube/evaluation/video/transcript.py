...
from herald.validator.clients.llm_client import check_for_prompt_injection
from herald.validator.platforms.youtube.api.transcript import (
    get_video_transcript as fetch_video_transcript_api,
)
from herald.validator.platforms.youtube.utils import _format_error
from herald.validator.utils.config import RAPID_API_KEY
    ...
    if transcript is None:
        try:
            ...
            log_and_raise_api_error(
                ...
                params={"herald_video_id": video_data.get("heraldVideoId", "unknown")},
