...
from herald.validator.platforms.youtube.api.video import (
    get_video_analytics,
    get_video_data_batch,
)
from herald.validator.platforms.youtube.config import (
    get_youtube_metrics,
)
from herald.validator.platforms.youtube.utils import _format_error, state
from herald.validator.utils.config import DISCRETE_MODE, ECO_MODE, DISABLE_PROMPT_INJECTION
...
def vet_video(video_id, briefs, video_data, video_analytics):
    ...
    """
    bt.logging.info(f"=== Evaluating video: {video_data['heraldVideoId']} ===")
