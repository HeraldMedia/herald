#!/usr/bin/env python3
"""
Manual Authentication Script for Herald Miner
...
def manual_auth_flow():
    ...
    try:
        ...
        flow.redirect_uri = 'https://dashboard.herald.network/echo'
        ...
        print("3. You'll be redirected to the Herald echo service")
        ...
        print("🎉 You can now run your Herald miner!")
...
def main():
    print("Herald Miner - Manual Authentication Tool")
    print("=" * 50)
