...
from herald.validator.utils.run_manager import RunManager, generate_current_run_id
...
class TestRunManagerCore:
    ...
    @patch('herald.validator.utils.run_manager.datetime')
    ...
    def test_reset_run_id(self):
        ...
        with patch('herald.validator.utils.run_manager.datetime') as mock_datetime:
            mock_datetime.utcnow.return_value.strftime.return_value = "20250106_120000"
    ...
    @patch('herald.validator.utils.run_manager.datetime')
    @patch('herald.validator.utils.run_manager.get_run_manager')
