...
from herald.validator.utils.streaming_publisher import (
...
class TestStreamingPublisher:
    ...
    @patch('herald.validator.utils.streaming_publisher.ENABLE_DATA_PUBLISH', True)
    @patch('herald.validator.utils.streaming_publisher.publish_single_account', new_callable=AsyncMock)
    @pytest.mark.asyncio
    ...
    @patch('herald.validator.utils.streaming_publisher.ENABLE_DATA_PUBLISH', False)
    @patch('herald.validator.utils.streaming_publisher.publish_single_account', new_callable=AsyncMock)
    @pytest.mark.asyncio
