...
from herald.validator.platforms.youtube.evaluation.score_cap import (
...
class TestGetCapPeriodDates:
    ...
    def test_get_cap_period_dates_calculation(self):
        ...
        with patch('herald.validator.platforms.youtube.evaluation.score_cap.datetime') as mock_datetime:
...
class TestCalculateMedianFromAnalytics:
    ...
    def test_calculate_median_basic_revenue(self):
        ...
        with patch('herald.validator.platforms.youtube.evaluation.score_cap.get_cap_period_dates') as mock_dates:
