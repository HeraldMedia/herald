...
from herald.validator.reward_engine.models.evaluation_result import EvaluationResultCollection
...
class TestRewardDistributionService:
    ...
    def test_yt_min_emissions_interaction(self):
        ...
        with patch('herald.validator.reward_engine.services.reward_distribution_service.YT_MIN_EMISSIONS', 0.01):
    ...
    def test_global_minimum_scaling_with_caps_interaction(self):
        ...
        with patch('herald.validator.reward_engine.services.reward_distribution_service.YT_MIN_EMISSIONS', 0.8):
