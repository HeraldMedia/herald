...
class TestEmissionCalculationService:
    ...
    def test_boost_field_not_specified_defaults_to_one(self, sample_briefs, sample_score_matrix):
        ...
        with patch('herald.validator.reward_engine.services.emission_calculation_service.get_herald_alpha_price', return_value=1.0), \
             patch('herald.validator.reward_engine.services.emission_calculation_service.get_total_miner_emissions', return_value=1000.0):
