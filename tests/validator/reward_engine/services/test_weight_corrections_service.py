...
from herald.validator.reward_engine.models.evaluation_result import EvaluationResultCollection, AccountResult
...
class TestWeightCorrectionsService:
    ...
    def test_calculate_corrections_basic(self):
        ...
        for correction in corrections:
            assert correction["content_id"] == "herald_video123"
    ...
    def test_extract_content_id(self):
        ...
        # Normal case with heraldVideoId
        video_data = {
            "details": {"heraldVideoId": "herald_abc123"}
        }
        content_id = self.service._extract_content_id(video_data, "fallback_id")
        assert content_id == "herald_abc123"
        
        # Missing heraldVideoId - use fallback
        video_data = {
