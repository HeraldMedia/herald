...
class TestRewardOrchestratorServices:
    ...
    async def test_service_initialization(self, mock_get_briefs):
        ...
        from herald.validator.reward_engine.services.miner_query_service import MinerQueryService
        from herald.validator.reward_engine.services.platform_registry import PlatformRegistry
        from herald.validator.reward_engine.services.score_aggregation_service import ScoreAggregationService
        from herald.validator.reward_engine.services.emission_calculation_service import EmissionCalculationService
