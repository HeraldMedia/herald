...
class TestYouTubeIntegration:
    ...
    @pytest.mark.asyncio
    @patch('herald.validator.platforms.youtube.youtube_evaluator.eval_youtube')  # Patch where it's imported
    ...
    @pytest.mark.asyncio
    @patch('herald.validator.platforms.youtube.youtube_evaluator.eval_youtube')
...
class TestYouTubeEvaluatorUnit:
    ...
    @patch('herald.validator.platforms.youtube.youtube_evaluator.YT_MIN_ALPHA_STAKE_THRESHOLD', 5000)
    ...
    def test_max_accounts_per_synapse_limit(self):
        ...
        from herald.validator.utils.config import MAX_ACCOUNTS_PER_SYNAPSE
