...
from herald.validator.reward_engine.models.evaluation_result import EvaluationResultCollection, EvaluationResult, AccountResult
from herald.validator.reward_engine.models.score_matrix import ScoreMatrix
...
class TestCapsIntegration:
    ...
    def test_caps_with_subnet_treasury(self):
        ...
        with patch('herald.validator.reward_engine.services.reward_distribution_service.allocate_subnet_treasury') as mock_treasury:
