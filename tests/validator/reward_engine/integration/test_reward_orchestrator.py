...
from herald.validator.reward_engine.orchestrator import RewardOrchestrator
from herald.validator.reward_engine.services.platform_registry import PlatformRegistry
from herald.validator.platforms.youtube.youtube_evaluator import YouTubeEvaluator
from herald.validator.reward_engine.models.miner_response import MinerResponse
from herald.validator.reward_engine.models.evaluation_result import EvaluationResult, AccountResult
...
class TestRewardOrchestrator:
    ...
    @pytest.mark.asyncio
    @patch('herald.validator.utils.briefs.get_briefs')
    @patch('herald.validator.utils.token_pricing.get_herald_alpha_price')
    @patch('herald.validator.utils.token_pricing.get_total_miner_emissions')
...
class TestRewardOrchestoratorIntegration:
    ...
    @patch('herald.validator.utils.token_pricing.get_herald_alpha_price')
    @patch('herald.validator.utils.token_pricing.get_total_miner_emissions')
    @patch('herald.validator.rewards_scaling.allocate_subnet_treasury')
...
class TestOrchestratorBatching:
    ...
    @pytest.mark.asyncio
    @patch('herald.validator.reward_engine.orchestrator.CREDENTIAL_BATCH_SIZE', 3)
    @patch('herald.validator.reward_engine.orchestrator.MAX_ACCOUNTS_PER_SYNAPSE', 1000)
    ...
    @pytest.mark.asyncio
    @patch('herald.validator.reward_engine.orchestrator.CREDENTIAL_BATCH_SIZE', 10)
    @patch('herald.validator.reward_engine.orchestrator.MAX_ACCOUNTS_PER_SYNAPSE', 1000)
    ...
    @pytest.mark.asyncio
    @patch('herald.validator.reward_engine.orchestrator.CREDENTIAL_BATCH_SIZE', 2)
    @patch('herald.validator.reward_engine.orchestrator.MAX_ACCOUNTS_PER_SYNAPSE', 1000)
