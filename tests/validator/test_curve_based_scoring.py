...
from herald.validator.platforms.youtube.evaluation.curve_based_scoring import (
...
class TestCurveBasedScoring(unittest.TestCase):
    ...
    @patch('herald.validator.platforms.youtube.evaluation.curve_based_scoring.datetime')
    ...
    @patch('herald.validator.platforms.youtube.evaluation.curve_based_scoring._calculate_non_ypp_curve_score')
