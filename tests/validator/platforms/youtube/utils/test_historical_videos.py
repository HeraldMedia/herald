    ...
    return [
        {
            ...
            "herald_channel_id": "herald_channel_A",
            "date_first_matched": today,
            "brief_id": "brief_123"
        },
        {
            "video_id": "video_2",
            "herald_video_id": "herald_video_2",
            "channel_id": "channel_A",
            "herald_channel_id": "herald_channel_A",
        ...
        {
            "video_id": "video_3",
            "herald_video_id": "herald_video_3",
            "channel_id": "channel_B",
            "herald_channel_id": "herald_channel_B",
...
class TestRecordVideoMatch:
    ...
    def test_record_new_match(self, temp_historical_file):
        ...
        record_video_match(
            video_id="test_video",
            herald_video_id="herald_test_video",
        ...
        with open(temp_historical_file, 'r') as f:
            ...
            assert entry["herald_video_id"] == "herald_test_video"
            assert entry["channel_id"] == "test_channel"
            assert entry["herald_channel_id"] == "herald_test_channel"
    ...
    def test_record_different_videos_same_channel(self, temp_historical_file):
        ...
        for i in range(3):
            record_video_match(
                video_id=f"video_{i}",
                herald_video_id=f"herald_video_{i}",
                channel_id="test_channel",
                herald_channel_id="herald_test_channel",
                brief_id=f"brief_{i}"
            )
...
class TestGetHistoricalVideos:
    ...
    def test_get_videos_deduplicates(self, temp_historical_file):
        ...
        with open(temp_historical_file, 'w') as f:
            ...
            for i in range(3):
                entry = {
                    "video_id": "same_video",
                    "herald_video_id": "herald_same_video",
                    "channel_id": "test_channel",
                    "herald_channel_id": "herald_test_channel",
                    "date_first_matched": today,
                    "brief_id": f"brief_{i}"
    ...
    def test_get_videos_handles_malformed_entries(self, temp_historical_file):
        ...
        with open(temp_historical_file, 'w') as f:
            ...
            good_entry = {
                "video_id": "good_video",
                "herald_video_id": "herald_good_video",
                "channel_id": "test_channel",
                "herald_channel_id": "herald_test_channel",
                "date_first_matched": today,
                "brief_id": "brief_1"
            ...
            good_entry2 = {
                ...
                "herald_video_id": "herald_good_video2",
                "channel_id": "test_channel",
                "herald_channel_id": "herald_test_channel",
                "date_first_matched": today,
                "brief_id": "brief_2"
        ...
        def write_entries(thread_id):
            for i in range(10):
                record_video_match(
                    ...
                    herald_video_id=f"herald_video_{thread_id}_{i}",
                    channel_id=f"channel_{thread_id}",
                    herald_channel_id=f"herald_channel_{thread_id}",
                    brief_id=f"brief_{i}"
                )
