...
from herald.validator.platforms.youtube.main import (
...
def temp_historical_file(tmp_path):
    ...
    with patch('herald.validator.platforms.youtube.utils.historical_videos.HISTORICAL_VIDEOS_PATH', test_file):
        yield test_file
...
def mock_result():
    ...
    return {
        "yt_account": {
            "details": {
                "id": "test_channel_id",
                "heraldChannelId": "herald_test_channel"
            },
            "analytics": {
                "ypp": True
            }
...
def mock_video_data():
    ...
    return {
        "video_1": {
            "videoId": "video_1",
            "heraldVideoId": "herald_video_1",
            "title": "Test Video 1",
            "publishedAt": datetime.now().strftime("%Y-%m-%dT%H:%M:%SZ")
        },
        "video_2": {
            "videoId": "video_2",
            "heraldVideoId": "herald_video_2",
            "title": "Test Video 2",
            "publishedAt": datetime.now().strftime("%Y-%m-%dT%H:%M:%SZ")
        }
    }
...
class TestEndToEndRecording:
    ...
    @patch('herald.validator.platforms.youtube.main.ECO_MODE', False)
    def test_matching_video_recorded_to_registry(
        ...
        with patch('herald.validator.platforms.youtube.main.update_video_score'):
            process_single_video(
                video_id=video_id,
        ...
        with open(temp_historical_file, 'r') as f:
            ...
            assert entry["herald_video_id"] == "herald_video_1"
...
class TestEndToEndRetrieval:
    ...
    @patch('herald.validator.platforms.youtube.main.ECO_MODE', False)
    @patch('herald.validator.platforms.youtube.main.get_all_uploads')
    @patch('herald.validator.platforms.youtube.main.vet_videos')
    def test_historical_videos_added_to_processing(
        ...
        with open(temp_historical_file, 'w') as f:
            ...
            entry = {
                ...
                "herald_video_id": "herald_historical_video_1",
                "channel_id": "test_channel_id",
                "herald_channel_id": "herald_test_channel",
    ...
    def test_deduplication_of_historical_and_recent(
        ...
        with open(temp_historical_file, 'w') as f:
            ...
            entry = {
                ...
                "herald_video_id": "herald_video_1",
                "channel_id": "test_channel_id",
                "herald_channel_id": "herald_test_channel",
                "date_first_matched": today,
                "brief_id": "brief_1"
...
class TestEcoModeIntegration:
    ...
    @patch('herald.validator.platforms.youtube.utils.historical_videos.ECO_MODE', True)
    @patch('herald.validator.platforms.youtube.main.ECO_MODE', True)
...
class TestNaturalScoringExclusion:
    ...
    def test_old_video_scores_zero_naturally(
        ...
        video_data_dict = {
            "old_video": {
                "videoId": "old_video",
                "heraldVideoId": "herald_old_video",
                "title": "Old Video",
