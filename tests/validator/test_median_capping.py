...
from herald.validator.platforms.youtube.evaluation.median_capping import (
...
class TestMedianCapping(unittest.TestCase):
    ...
    def test_calculate_median_cap_period_basic(self):
        ...
        with patch('herald.validator.platforms.youtube.evaluation.median_capping.datetime') as mock_datetime:
