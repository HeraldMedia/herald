...
from herald.validator.platforms.youtube.main import update_video_score, check_video_brief_matches, _get_youtube_scaling_factor, _get_lifetime_deduction
...
def test_update_video_score():
    ...
    with patch('herald.validator.platforms.youtube.evaluation.scoring.YT_ROLLING_WINDOW', 1), \
         patch('herald.validator.platforms.youtube.main.calculate_video_score') as mock_calculate, \
         patch('herald.validator.platforms.youtube.main.calculate_adjusted_curve_difference') as mock_adjusted, \
         patch('herald.validator.platforms.youtube.main.get_herald_alpha_price', return_value=1.0), \
         patch('herald.validator.platforms.youtube.main.get_total_miner_emissions', return_value=1000.0):
        ...
        result["videos"][video_id_1] = {
            "details": {"heraldVideoId": video_id_1}, 
            "analytics": {}
        }
        ...
        result["videos"][video_id_2] = {
            "details": {"heraldVideoId": video_id_2}, 
            "analytics": {}
        }
        ...
        result["videos"][video_id_3] = {
            "details": {"heraldVideoId": video_id_3}, 
            "analytics": {}
        }
        ...
        result["videos"][video_id_4] = {
            "details": {"heraldVideoId": video_id_4}, 
            "analytics": {}
        }
...
def test_process_videos_empty_briefs():
    ...
    with patch('herald.validator.platforms.youtube.main.get_all_uploads') as mock_get_uploads, \
         patch('herald.validator.platforms.youtube.main.vet_videos') as mock_vet_videos:
        ...
        # Call the function
        from herald.validator.platforms.youtube.main import process_videos
...
def test_calculate_video_score_revenue_based():
    ...
    from herald.validator.platforms.youtube.evaluation.scoring import calculate_video_score
    ...
    with patch('herald.validator.platforms.youtube.evaluation.scoring.get_video_analytics') as mock_analytics, \
         patch('herald.validator.platforms.youtube.evaluation.scoring.YT_ROLLING_WINDOW', 7):
        ...
        with patch('herald.validator.platforms.youtube.evaluation.scoring.datetime') as mock_datetime:
...
def test_calculate_video_score_non_ypp_with_cached_ratio():
    ...
    from herald.validator.platforms.youtube.evaluation.scoring import calculate_video_score
    from herald.validator.utils.config import ECO_MODE
    ...
    with patch('herald.validator.platforms.youtube.evaluation.scoring.get_video_analytics') as mock_get_analytics:
        ...
        with patch('herald.validator.platforms.youtube.evaluation.scoring.get_youtube_metrics') as mock_get_metrics:
            ...
            with patch('herald.validator.platforms.youtube.evaluation.scoring.YT_ROLLING_WINDOW', 7):
...
def test_calculate_video_score_non_ypp_no_cached_ratio():
    ...
    from herald.validator.utils.config import YT_NON_YPP_REVENUE_MULTIPLIER
...
def test_select_highest_priority_brief():
    ...
    from herald.validator.platforms.youtube.evaluation.video import select_highest_priority_brief
...
def test_boost_factor_applied_in_usd_calculations():
    ...
    from herald.validator.platforms.youtube.main import _calculate_per_video_metrics
    
    # Mock pricing and adjusted curve to isolate boost/scaling logic
    with patch('herald.validator.platforms.youtube.main.get_herald_alpha_price', return_value=10.0), \
         patch('herald.validator.platforms.youtube.main.get_total_miner_emissions', return_value=1000.0), \
         patch('herald.validator.platforms.youtube.main.calculate_adjusted_curve_difference', return_value=1.0):
...
def test_get_youtube_scaling_factor():
    ...
    from herald.validator.utils.config import YT_SCALING_FACTOR_DEDICATED, YT_SCALING_FACTOR_AD_READ
...
def test_get_lifetime_deduction():
    ...
    from herald.validator.utils.config import YT_LIFETIME_DEDUCTION, YT_LIFETIME_DEDUCTION_AD_READ
