...
from herald.validator.platforms.youtube.evaluation import (
    vet_video,
    check_video_privacy,
...
@patch('herald.validator.platforms.youtube.evaluation.video.orchestration.ECO_MODE', True)
@patch('herald.validator.platforms.youtube.evaluation.video.orchestration.check_video_privacy', Mocks.mock_check_video_privacy_fail)
def test_eco_mode_enabled_early_return():
    ...
    with patch('herald.validator.platforms.youtube.evaluation.video.orchestration.check_video_publish_date') as mock_publish_date, \
         patch('herald.validator.platforms.youtube.evaluation.video.orchestration.check_manual_captions') as mock_captions, \
         patch('herald.validator.platforms.youtube.evaluation.video.orchestration.get_video_transcript') as mock_transcript, \
         patch('herald.validator.platforms.youtube.evaluation.video.orchestration.check_prompt_injection') as mock_prompt_injection, \
         patch('herald.validator.platforms.youtube.evaluation.video.orchestration.evaluate_content_against_briefs') as mock_evaluate:
...
@patch('herald.validator.platforms.youtube.evaluation.video.orchestration.ECO_MODE', False)
@patch('herald.validator.platforms.youtube.evaluation.video.orchestration.check_video_privacy', Mocks.mock_check_video_privacy_fail)
...
def test_eco_mode_early_return_at_each_stage():
    ...
    with patch('herald.validator.platforms.youtube.evaluation.video.orchestration.check_video_privacy',
               return_value=False), \
         patch('herald.validator.platforms.youtube.evaluation.video.orchestration.check_video_publish_date') as mock_publish_date, \
         patch('herald.validator.platforms.youtube.evaluation.video.orchestration.evaluate_content_against_briefs') as mock_evaluate:
    ...
    with patch('herald.validator.platforms.youtube.evaluation.video.orchestration.check_video_privacy',
               return_value=True), \
         patch('herald.validator.platforms.youtube.evaluation.video.orchestration.check_video_publish_date',
               return_value=False), \
         patch('herald.validator.platforms.youtube.evaluation.video.orchestration.check_manual_captions') as mock_captions, \
         patch('herald.validator.platforms.youtube.evaluation.video.orchestration.evaluate_content_against_briefs') as mock_evaluate:
    ...
    with patch('herald.validator.platforms.youtube.evaluation.video.orchestration.check_video_privacy',
         ...
         patch('herald.validator.platforms.youtube.evaluation.video.orchestration.check_video_publish_date',
               return_value=True), \
         patch('herald.validator.platforms.youtube.evaluation.video.orchestration.check_manual_captions',
               return_value=False), \
         patch('herald.validator.platforms.youtube.evaluation.video.orchestration.get_video_transcript') as mock_transcript, \
         patch('herald.validator.platforms.youtube.evaluation.video.orchestration.evaluate_content_against_briefs') as mock_evaluate:
...
@patch('herald.validator.platforms.youtube.evaluation.video.orchestration.DISABLE_PROMPT_INJECTION', False)
@patch('herald.validator.platforms.youtube.evaluation.video.orchestration.ECO_MODE', False)
def test_eco_mode_disabled_full_pipeline():
    ...
    with patch('herald.validator.platforms.youtube.evaluation.video.orchestration.check_video_privacy',
         ...
         patch('herald.validator.platforms.youtube.evaluation.video.orchestration.get_video_transcript',
               return_value="Mock transcript") as mock_transcript, \
         patch('herald.validator.platforms.youtube.evaluation.video.orchestration.check_prompt_injection',
...
def test_early_return_flag():
    ...
    with patch('herald.validator.platforms.youtube.evaluation.video.orchestration.check_video_privacy',
         ...
         patch('herald.validator.platforms.youtube.evaluation.video.orchestration.check_prompt_injection') as mock_prompt_injection, \
         patch('herald.validator.platforms.youtube.evaluation.video.orchestration.evaluate_content_against_briefs',
