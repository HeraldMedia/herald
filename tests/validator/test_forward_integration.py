...
from herald.validator.forward import forward, get_reward_orchestrator
...
class TestForwardIntegration:
    ...
    @pytest.mark.asyncio
    @patch('herald.validator.forward.get_all_uids')
    @patch('herald.validator.forward.get_briefs')
    @patch('time.sleep')
    ...
    @pytest.mark.asyncio
    @patch('herald.validator.forward.get_reward_orchestrator')
