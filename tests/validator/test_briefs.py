...
from herald.validator.utils.briefs import get_briefs, BriefsCache
from herald.validator.utils.config import YT_REWARD_DELAY
...
def test_get_briefs_with_reward_delay(monkeypatch):
    ...
    current_date = datetime.now(timezone.utc).date()
    from herald.validator.utils.config import YT_SCORING_WINDOW, YT_REWARD_DELAY
