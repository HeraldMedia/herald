...
from herald.validator.platforms.youtube.evaluation.proportional_scaling import (
...
class TestProportionalScaling(unittest.TestCase):
    ...
    @patch('herald.validator.platforms.youtube.evaluation.proportional_scaling.calculate_median_from_analytics')
    ...
    @patch('herald.validator.platforms.youtube.evaluation.proportional_scaling.get_median_threshold_for_metric')
    ...
    @patch('herald.validator.platforms.youtube.evaluation.proportional_scaling.bt.logging')
