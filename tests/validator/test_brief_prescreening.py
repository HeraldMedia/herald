...
from herald.validator.platforms.youtube.evaluation.video import (
...
class TestBriefPreScreening:
    ...
    def test_check_brief_unique_identifier_case_insensitive(self):
        ...
        brief = {"id": "test1", "unique_identifier": "HERALD2024"}
        description = "This video is about herald2024 and blockchain technology"
