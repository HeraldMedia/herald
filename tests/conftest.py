...
def mock_external_apis():
    ...
    """
    with patch('herald.validator.utils.briefs.get_briefs') as mock_briefs, \
         patch('herald.validator.utils.token_pricing.get_herald_alpha_price') as mock_price, \
         patch('herald.validator.utils.token_pricing.get_total_miner_emissions') as mock_emissions, \
         patch('herald.validator.clients.llm_client.evaluate_content_against_brief') as mock_llm_eval, \
         patch('herald.validator.clients.llm_client.check_for_prompt_injection') as mock_llm_inject, \
         patch('herald.validator.platforms.youtube.api.transcript._fetch_transcript') as mock_transcript, \
...
def mock_youtube_api_calls():
    ...
    """
    with patch('herald.validator.platforms.youtube.api.clients.initialize_youtube_clients') as mock_clients, \
         patch('herald.validator.platforms.youtube.api.channel.get_channel_data') as mock_channel_data, \
         patch('herald.validator.platforms.youtube.api.channel.get_channel_analytics') as mock_channel_analytics, \
         patch('herald.validator.platforms.youtube.api.video.get_all_uploads') as mock_uploads, \
         patch('herald.validator.platforms.youtube.api.video.get_video_data_batch') as mock_video_data, \
         patch('herald.validator.platforms.youtube.api.video.get_video_analytics') as mock_video_analytics:
