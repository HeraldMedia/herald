...
VENV_PATH="$PROJECT_PARENT/venv_herald"

echo "Herald Miner - Authentication Setup"
echo "===================================="
...
if [ ! -f "secrets/client_secret.json" ]; then
    ...
    echo "Location: $PROJECT_ROOT/herald/miner/secrets/client_secret.json"
    echo ""
